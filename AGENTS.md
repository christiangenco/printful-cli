...
printful-cli estimate --variant 4020 --file design.png        # Price estimate
printful-cli estimate --variant 4020 --file design.png --quantity 5   # Bulk estimate
printful-cli order --variant 4020 --file design.png           # Show estimate (no order placed)
printful-cli order --variant 4020 --file design.png --confirm # Actually place order
...
# Get price estimate (variant 4020 = Black 2XL)
printful-cli estimate --variant 4020 --file ~/designs/cool-shirt.png

# Order a shirt with a design (without --confirm shows estimate only)
printful-cli order --variant 4020 --file ~/designs/cool-shirt.png --confirm
```
